...
I have changed some links in the article to reflect the latest version of DTGridView, which can be found at its own repository at "http://bitbucket.org/danielctull/dtgridview":http://bitbucket.org/danielctull/dtgridview.